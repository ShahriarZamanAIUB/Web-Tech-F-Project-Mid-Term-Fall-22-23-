            ...
            <fieldset>
                ...
                <table align="center" height="700px" width="700px"  border="1" style="background-color:#FFFFE0;">
                   ...
                   <?php
                    ...
                    <tr>
                        <td>
                            <table align="center" border="1" width="100%" height="100%" style="background-color:#E6E6FA;"  >
                     ...
                     <tr> <td> <hr>  </td></tr>
                      ...
                      <tr><td style="padding:10px"><b>Username: <?php echo $_COOKIE['username']; ?></td></tr> 
                      <tr><td style="padding:10px"><b>Orders: </td> </tr>
                      <tr><td style="padding:10px"><b>Balance: Tk. <?php echo $_COOKIE['balance']; ?></td> </tr>
